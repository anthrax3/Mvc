...
{
    /// <summary>
    /// Contains methods used to generate the HTML controls from the given display templates
    /// </summary>
    /// <remarks>
    /// The user-provided display templates should be located under the "DisplayTemplates" folder. 
